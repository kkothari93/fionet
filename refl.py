...
def main():
    ...
    # load the direct wave on the background
    # this wave corresponds to the wave reaching the sensor directly
    ...
    d1_grids = flows[:, 64-1:192+1, 64-1:192+1, :2]
    ...
    b1 = tf.cond(step > HEAD_START, lambda: inp_d1, lambda: inp_wo_direct)
